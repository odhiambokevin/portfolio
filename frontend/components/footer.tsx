  ...
  return (
    <footer className="footer section-shell">
        ...
        <div className="socials">
            <Link href="mailto:odhiambosiaya@proton.me" aria-label="Email">
                <Mail size={17} />
            </Link>

            <Link href="https://github.com/odhiambokevin" aria-label="GitHub" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="17px" height="30px" viewBox="0 0 24 24" fill="currentColor">
