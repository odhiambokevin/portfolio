   ...
   <main className="">
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">geospatial developer</h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">hi, i am kevin, a fullstack geospatial developer from kenya. i specialize in GIS apps with secure and automated spatial database design</p>
            <a href="/#portfolio" className="relative inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                my work
            ...
            <a href="#contact" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-accent/70 dark:focus:ring-accent">
                contact me
            </a> 
        </div>
        <div className="relative hidden lg:mt-0 lg:col-span-5 lg:flex">
            ...
            <img src="/images/me.png" alt="mockup" className=""/>
        </div>                
    </div>
    ...
    <section id="map" className="h-[100svh] scroll-mt-[120px]">
      ...
      <a href="/map" className="mt-4 mx-auto inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        view all
      </a>
    </section>
    ...
    <section id="blog" className="h-[100svh] scroll-mt-[120px]">
      ...
      {blogdata.slice(0,6).map((blog,index)=>(
        <div key={index} className="transition duration-300 ease-in-out  hover:scale-105">
          <div className="max-w-sm bg-white border border-gray-200 hover:bg-accent rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="rounded-t-lg" src={`/images/blog/${blog.image}`} alt="" />
              </a>
              <div className="p-5">
                  <a href="#">
      ...
      <a href="blog" className="mt-4 mx-auto inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        view all
      </a>
    </section>
