      ...
      <section id="home"  className="flex h-[100svh] dark:bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/green-gradient-bg.svg)] bg-top bg-no-repeat text-center">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16">
          <div className="relative z-1 pt-8">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">hi, i&apos;m kevin, a data engineer and geospatial developer from kenya. i specialize in automated <span className="text-accent">data pipeline </span> designs as well as developing digital infrastructure and solutions that <span className="text-accent">scale</span>, are reliable and leverage <span className="text-accent">automation</span></p>
