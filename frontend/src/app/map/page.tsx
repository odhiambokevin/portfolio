                ...
                <div key={index} className="transition duration-300 ease-in-out  hover:scale-105">
                  <div className="max-w-sm bg-white border border-gray-200 hover:bg-accent rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <div className="p-5">
                          ...
                          <Link href={`map/${map.slug}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                              Read more
