    ...
    <div className="w-full px-4 lg:w-4/12">
      <div className="mb-10 mt-12 rounded-sm bg-text-mild/20 p-6 shadow-three lg:mt-0">
               <div className="relative w-3/4 mx-auto">
                <form className={`relative flex items-center gap-[8px] bg-gray-400 p-[4px] rounded-[8px] outline outline-secondary`}>
                    <input type="text" placeholder="Search" className="bg-transparent px-1 text-white outline-0"/>
                    <button className="absolute top-0 right-0 bottom-0 bg-secondary rounded-md rounded-bl-none rounded-tl-none px-2 py-[px] cursor-pointer">
              ...
              <div className="mb-10 rounded-sm bg-text-mild/20 shadow-three">
                ...
                <div className="flex flex-col p-8 text-text-mild">
                  <Link href="#" className="mb-6 border-b border-body-color border-opacity-10 pb-6">
                    Django is cool
                  </Link >
                  <Link href="#" className="mb-6 border-b border-body-color border-opacity-10 pb-6">
